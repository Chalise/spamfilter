...
def get_classifier():
    ...
    # gets testdata files
    test_set1 = 'spamdata/testing_set/nonspam-test'
    test_set2 = 'spamdata/testing_set/spam-test'
#missing reading test file code

    # calls naive bayes classifier and trains it
    combine_test_list = test_set1.extend(test_set2)
    classifier = nltk.NaiveBayesClassifier.train(combine_list)

    # counts classifiers accurasy using testing set
    Accuracy = nltk.classify.util.accuracy(classifier, combine_test_list)
